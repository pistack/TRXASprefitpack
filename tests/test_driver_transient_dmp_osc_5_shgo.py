...
def test_driver_transient_dmp_osc_5_shgo():
    fwhm = 0.08
    ...
    y_obs_2 = dmp_osc_conv(t_seq-t0[0], fwhm, tau, period, phase_2, abs_2, irf='c')
    y_obs_3 = dmp_osc_conv(t_seq-t0[0], fwhm, tau, period, phase_3, abs_3, irf='c')
    y_obs_4 = dmp_osc_conv(t_seq-t0[0], fwhm, tau, period, phase_4, abs_4, irf='c')
