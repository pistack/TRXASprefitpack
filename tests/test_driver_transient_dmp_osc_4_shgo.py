...
def test_driver_transient_dmp_osc_4_shgo():
    fwhm = 0.100
    ...
    y_obs_2 = dmp_osc_conv(t_seq-t0[0], fwhm, tau, period, phase_2, abs_2, irf='g')
    y_obs_3 = dmp_osc_conv(t_seq-t0[0], fwhm, tau, period, phase_3, abs_3, irf='g')
    y_obs_4 = dmp_osc_conv(t_seq-t0[0], fwhm, tau, period, phase_4, abs_4, irf='g')
    ...
    method_glb='shgo', bound_fwhm=bound_fwhm, bound_t0=bound_t0, same_t0=True,
