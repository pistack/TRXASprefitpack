...
def test_driver_transient_both_6():
    tau_1 = 1
    tau_2 = 10
    tau_3 = 1000
    fwhm_G = 0.05
    ...
    irf='pv', eta=eta) + \
        dmp_osc_conv(t_seq-t0[0], fwhm, tau_osc, period_osc, phase_2, abs_osc_2,
        irf='pv', eta=eta)
    y_obs_3 = rate_eq_conv(t_seq-t0[0], fwhm, abs_3, eigval_seq, V_seq, c_seq,
    irf='pv', eta=eta) + \
        dmp_osc_conv(t_seq-t0[0], fwhm, tau_osc, period_osc, phase_3, abs_osc_3,
        irf='pv', eta=eta)
    y_obs_4 = rate_eq_conv(t_seq-t0[0], fwhm, abs_4, eigval_seq, V_seq, c_seq,
    irf='pv', eta=eta) + \
        dmp_osc_conv(t_seq-t0[0], fwhm, tau_osc, period_osc, phase_4, abs_osc_4,
        irf='pv', eta=eta)
