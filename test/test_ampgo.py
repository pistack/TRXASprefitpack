...
class TestGradTestFun(unittest.TestCase):
    def test_grad_six_hump_camelback(self):
...
class TestAMPGO(unittest.TestCase):

    def test_ampgo_1(self):
        '''
        numerical gradient
        '''
        cond_f = True; cond_x = True
        for i in range(1):
            x0 = np.random.uniform(-5, 5, 2)
            ...
            cond_f = cond_f and tmp_cond_f; cond_x = cond_x and tmp_cond_x
        self.assertEqual((cond_f, cond_x), (True, True))

    def test_ampgo_2(self):
        '''
        analytical gradient
        '''
        cond_f = True; cond_x = True
    ...
    def test_fun_grad_tunnel(self):
        ...
        self.assertEqual((cond_ttf, cond_grad), (True, True))
